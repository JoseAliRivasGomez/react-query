          ...
          <div>
            <div className={formValues.postType === 'Scheduled' ? "mb-2 block px-4" : "mb-2 px-4 hidden"}>
              <Label
                ...
                value="Schedule At"
              />
              <DatePicker id="scheduledAt" selected={formValues.scheduledAt} className="w-full border-1 border-gray-300 rounded-lg" showTimeSelect timeIntervals={1} locale="es" timeCaption='Hora'
                onChange={(event) => onDateChange(event, 'scheduledAt')} dateFormat="Pp" minDate={currentDate} disabled={postState ? true: false} />
            </div>
