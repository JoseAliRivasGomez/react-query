...
export const SchedulesPage = () => {
    ...
    useEffect(() => {
        ...
        const interval = setInterval(() => {
          setTimeUTC(new Date().toISOString().substring(10,19).replace('T',' '));

          const currentDate = new Date(new Date().toISOString().substring(0,19).replace('T',' '));
  ...
  return (
    <div className="App">
      ...
      <div className="text-lg grid grid-cols-1 justify-items-center gap-1 mb-5 mt-2">
        <h2> Current Day UTC: {dayUTC}</h2>
        <h2> Current Time UTC: {timeUTC}</h2>
      </div>      
